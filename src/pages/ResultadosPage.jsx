...
export const ResultadosPage = () => {
  ...
  return (
    <>
      ...
      <h1>Hola {nombre}, tu puntaje es de {puntaje1}</h1>
      ...
      {datos?.[0] && <p>Primer Lugar: {datos[0].nombre} con un puntaje de {datos[0].puntaje}</p>}
      {datos?.[1] && <p>Segundo Lugar: {datos[1].nombre} con un puntaje de {datos[1].puntaje}</p>}
      {datos?.[2] && <p>Tercer Lugar: {datos[2].nombre} con un puntaje de {datos[2].puntaje}</p>}
      {datos?.[3] && <p>Cuarto Lugar: {datos[3].nombre} con un puntaje de {datos[3].puntaje}</p>}
      {datos?.[4] && <p>Quinto Lugar: {datos[4].nombre} con un puntaje de {datos[4].puntaje}</p>}
      {datos?.[5] && <p>Sexto Lugar: {datos[5].nombre} con un puntaje de {datos[5].puntaje}</p>}
    </>
  );
};
